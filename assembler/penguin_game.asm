...
INIT:
  ...
  WHILE  i <= SHOT_AMOUNT
    MOVHI 5 BFFFBFFF
    MOVLO 5 BFFFBFFF
    STORE.R 5 CURRENT_SHOT_START 0

    MOVHI 5 0
    MOVLO 5 0
    
    STORE.R 5 CURRENT_SHOT_START 1
    STORE.R 5 CURRENT_SHOT_START 2
    STORE.R 5 CURRENT_SHOT_START 3
