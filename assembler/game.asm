...
SHOOT:
  ...
  IF TIMER >= LAST_SHOT
    ...
    #Store shot info
    STORE.R SHIP_REAL_POS SHOT_START 0
    STORE.R SHIPVEL SHOT_START 1
    STORE.R SHIP_ANGLE SHOT_START 2
...
UPDATE_SHOT:
  ...
  WHILE  i <= SHOT_AMOUNT
    ...
    STOREOBJ.R 4 SHOT_OFFSET 0
    STOREOBJ.R 0 SHOT_OFFSET 1
    STOREOBJ.R 0 SHOT_OFFSET 2
    STOREOBJ.R LINE_START SHOT_OFFSET 3
    #STOREOBJ.R 4 SHOT_OFFSET 1
    #STOREOBJ.R 4 SHOT_OFFSET 2
    #STOREOBJ.R 4 SHOT_OFFSET 3
