...
ENDIF
    ...
    3D modeller kan skapas i valfritt 3d modellerings program som  kan exportera
    ...
    obj\_converter.py
    konverterar en .obj fil till kordinaterna för alla linjer i modellen. Det
    andra  skriptet, coord\_generator.py tar listan av koordinater och genererar
    data som passar i objektminnet. Coord generator skriptet kan ta en parameter
	...
	\section{Slutsatser}
        ...
        visste i början av projektet att funktioner som liknande dessa skulle behövas men det var inte
