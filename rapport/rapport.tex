...
endfunc
    ...
    Ännu en unik instruktion är den som sätter ett till synes slumpmässigt tal i valfri register. För att lyckas med detta används komponenten Linear Feedback Shift Register.
